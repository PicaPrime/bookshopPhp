...
<head>
  ...
  <title>PrimeBooks</title>
  <link href="https://cdn.jsdelivr.net/npm/bootstrap@5.0.2/dist/css/bootstrap.min.css" rel="stylesheet" integrity="sha384-EVSTQN3/azprG1Anm3QDgpJLIm9Nao0Yz1ztcQTwFspd3yD65VohhpuuCOmLASjC" crossorigin="anonymous">

  <link rel="stylesheet" href="sass/main.scss">
  <link rel="stylesheet" href="sass/a.css">
                ...
                <div class="col-md-8 col-lg-6 col-xl-4 offset-xl-1">
                  <form>
                    ...
                    <div class="form-outline mb-4">
                      ...
                      <label class="form-label" for="form3Example3">Email address</label>
								<input type="email" name="users_email" class="form-control form-control-lg" id="form3Example3" placeholder="Enter your email" value="<?php if(isset($_POST['submit'])){echo $users_email; } ?>">
